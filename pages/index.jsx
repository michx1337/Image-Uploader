    ...
    <div className="p-8">
     {session ? (
      ...
      <>
       ...
       <button onClick={() => signIn()} className={`mt-6 flex cursor-pointer items-center gap-2 rounded-md border-0 bg-[#2869FF] py-2 px-4 text-sm font-semibold text-white duration-200 hover:bg-[#2355c8]`}>
